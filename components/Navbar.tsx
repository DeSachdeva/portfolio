...
const links = [
  ...
  { label: 'research',     href: '/research-patents' },
  ...
  return (
    <>
      <nav style={{
        ...
        height: '72px',
        background: scrolled ? 'rgba(8,12,16,0.98)' : 'rgba(8,12,16,0.85)',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
            ...
            <a
              href="https://github.com/desachdeva"
              target="_blank"
              rel="noreferrer"
              title="GitHub"
              style={{
            ...
            <a
              href="https://linkedin.com/in/devanshsachdeva"
              target="_blank"
              rel="noreferrer"
              title="LinkedIn"
              style={{
            ...
            >
              <span style={{
                width: '18px', height: '1.5px', background: 'var(--text2)',
